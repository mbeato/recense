...
- [x] 69-05-PLAN.md — `recense recall --evidence`: cited node ids + traversed edges instead of composed prose, zero generates and zero writes, prose mode unchanged (RECALL-04, wave 1)

**Wave 2** *(blocked on 69-01 + 69-02)*

- [x] 69-03-PLAN.md — Ambient integration: thread `cwd` into `ambientRecall` (the missing link), union anchored facts into reserved slots, and apply the ordering-only scope nudge; D-01 carve-out documented at `getNodeScopes` (RECALL-01, RECALL-02, wave 2)
